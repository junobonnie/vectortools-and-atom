# -*- coding: utf-8 -*-
"""
Created on Tue Jul 25 21:17:58 2023
...
class Vector:
    ...
    def __add__(self, other_Vector):
        new_arr = self.arr + other_Vector.arr
        return Vector(new_arr[0], new_arr[1])
    ...
    def __mul__(self, num):
        new_arr = num*self.arr
        return Vector(new_arr[0], new_arr[1])
    
    def __rmul__(self, num):   
        new_arr = self.arr*num
        return Vector(new_arr[0], new_arr[1])
    ...
    def dot(self, other_Vector):
        return np.dot(self.arr, other_Vector.arr)
    
    def cross(self, other_Vector):
        return np.cross(self.arr, other_Vector.arr)
